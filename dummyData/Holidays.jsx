...
export const Holidays = {
  ...
  "2025-05-05": [
    { name: "어린이날", type: "holiday" },
    { name: "부처님오신날", type: "holiday" }
  ],
  "2025-05-06": { name: "대체공휴일", type: "holiday" },  // 어린이날 대체
  "2025-06-03": { name: "대통령 선거일", type: "holiday" },
  "2025-06-06": { name: "현충일",   type: "holiday" },
  "2025-08-15": { name: "광복절",   type: "holiday" },
  "2025-09-30": { name: "추석 연휴", type: "holiday" },
  "2025-10-01": { name: "추석",     type: "holiday" },
  "2025-10-02": { name: "추석 연휴", type: "holiday" },
  "2025-10-03": { name: "개천절",   type: "holiday" },
  "2025-10-06": { name: "대체공휴일", type: "holiday" },  // 추석 대체공휴일
